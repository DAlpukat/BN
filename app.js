const BATIK = [
  {
    ...
    prov: "Jawa Tengah",
    teknik: "Tulis",
    warna: ["#7c2d12", "#b08968", "#fdf6e3"],
    img: "https://upload.wikimedia.org/wikipedia/commons/f/f5/Batik_pedalaman_-_parang_klithik.JPG",
    makna: "Kekuasaan yang bijak - parang = senjata, kusumo = bunga raja",
    filosofi:
      "Motif larangan keraton. Hanya raja & keluarga boleh pakai. Lurik parang melambangkan ombak yang tak pernah putus - penguasa harus terus bergerak, tapi tetap halus.",
    history:
      "Dicipta era Mataram Islam, abad 16. Dari kata 'pereng' (lereng) - bentuknya seperti lereng curam.",
    usage:
      "Upacara keraton, pernikahan adat Solo. Jangan pakai sembarangan di acara santai.",
    en: "Royal forbidden pattern. Symbol of wise power - wavy dagger means relentless yet refined leadership. Once only for kings.",
  },
  {
    id: "mega-mendung",
    nama: "Mega Mendung",
    ...
    prov: "Jawa Barat",
    teknik: "Tulis",
    warna: ["#0f2a4a", "#2a6496", "#8bbcd9"],
    img: "https://upload.wikimedia.org/wikipedia/commons/8/83/Batik_Mega_Mendung.jpg",
    makna: "Langit mendung yang menaungi - kesabaran & penahan amarah",
    filosofi:
      "7 gradasi warna dari gelap ke terang. Mendung tebal di atas, cerah di bawah - orang besar harus mampu menahan emosi, melindungi yang di bawah.",
    history:
      "Pengaruh Tionghoa abad 16, dari pelabuhan Cirebon. Awan bergelombang khas pesisir utara Jawa.",
    usage:
      "Kantor, kampus, acara semi-formal. Paling dicari turis karena gradasi cantik.",
    en: "Seven cloud gradations - teaches patience. Thick clouds above, bright below: leaders must shield, not burden.",
  },
  {
    id: "kawung",
    nama: "Kawung",
    ...
    prov: "DI Yogyakarta",
    teknik: "Tulis",
    warna: ["#7c2d12", "#c9a86a", "#fffbf5"],
    img: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Batik_pattern_-_kawung.jpg",
    makna: "Kejujuran & keseimbangan - buah kawung/aren yang murni",
    filosofi:
      "4 belah buah aren yang tertata rapi = 4 nafsu manusia yang harus terkendali. Titik tengah = hati yang bersih.",
    history:
      "Motif paling tua, era Mataram Kuno abad 9. Ditemukan di candi Prambanan.",
    usage: "Seragam PNS Yogya hari tertentu, batik formal netral.",
    en: "Oldest motif, 9th century. Four palm fruits = four human desires to balance. Center dot = pure heart.",
  },
  {
    id: "sidomukti",
    nama: "Sidomukti",
    ...
    history: "Kembangan dari motif Semen, era Kasunanan Surakarta abad 18.",
    usage: "Pernikahan, lamaran - doa kemakmuran untuk pengantin.",
    en: "Prosperity prayer - 'may life be prosperous'. Tiny fills mean life details matter.",
  },
  {
    id: "truntum",
    nama: "Truntum",
    ...
    prov: "Jawa Tengah",
    teknik: "Tulis",
    warna: ["#1f1a17", "#5a3a2a", "#fdf6e3"],
    img: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Batik_Truntum.jpg",
    makna: "Cinta yang tumbuh lagi - tuntas-tum-tum, bintang yang tumbuh",
    filosofi:
      "Dicipta Kanjeng Ratu untuk menumbuhkan cinta raja yang pudar. Bintang kecil bertaburan = cinta yang kembali bersinar.",
    history:
      "Dibuat Ratu Pakubuwono III, abad 18, dari patah hati yang dijahit jadi doa.",
    usage: "Orang tua pakai saat nikahkan anak - simbol cinta yang diturunkan.",
    en: "Queen created it to regrow king's love. Scattered stars = love that blooms again.",
  },
  {
    id: "lasem",
    ...
    prov: "Jawa Tengah",
    teknik: "Kombinasi",
    warna: ["#dc2626", "#1a365d", "#facc15"],
    img: "https://upload.wikimedia.org/wikipedia/commons/b/b5/Batik_Tiga_Negeri_Lasem_Tulis.jpg",
    makna: "Akulturasi - Tionghoa, Jawa, Belanda dalam satu kain",
    filosofi:
      "Merah Lasem (Chinese), biru sogan (Jawa), putih (Belanda). Bukti Indonesia memang persilangan, bukan pemurnian.",
    history:
      "Lasem kota candu & batik tertua pesisir, abad 14. Disebut 'Little China of Java'.",
    usage: "Koleksi, pameran budaya. Harga tinggi karena 3x pewarnaan.",
    en: "Three-nation batik: Chinese red, Javanese blue, Dutch white. Proof Indonesia is hybrid, not pure.",
  },
  {
    id: "pekalongan",
    nama: "Pekalongan Pesisir",
    daerah: "Pekalongan",
    prov: "Jawa Tengah",
    teknik: "Cap",
    warna: ["#ec4899", "#22c55e", "#facc15", "#38bdf8"],
    img: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Batik_Buketan_Pekalongan_Tulis_1.jpg",
    makna: "Keceriaan pesisir - bunga, kupu, burung bebas warna",
    filosofi:
      "Bebas pakem keraton. Pesisir = dagang = warna berani campur. Lawan dari sogan kraton yang kalem.",
    history:
      "Abad 19, Pekalongan jadi 'Kota Batik' lewat jalur perdagangan. Pengaruh Arab, Belanda, Tionghoa.",
    usage: "Sehari-hari, kerja kreatif, acara santai.",
    en: "Coastal freedom - no palace rules. Bright flora, butterflies. Batik's pop side.",
  },
  {
    id: "bali-merak",
    nama: "Merak Abyorhokokai",
    daerah: "Gianyar",
    prov: "Bali",
    teknik: "Tulis",
    warna: ["#059669", "#f59e0b", "#1a365d"],
    img: "https://www.iwarebatik.org/wp-content/uploads/2019/08/4-1.png",
    makna: "Keanggunan & kebanggaan - burung merak yang mekar",
    filosofi:
      "Ciptaan Iwan Tirta era 1990s untuk Bali modern. Merak = percaya diri, tapi tetap anggun.",
    history:
      "Batik Bali baru marak 1970-an, tak terikat pakem Jawa. Banyak motif flora-fauna tropis.",
    usage: "Resort, wedding Bali, turis wajib.",
    en: "Modern Bali, 1990s. Peacock = proud yet graceful. Tourist favorite.",
  },
  {
    id: "dayak",
    nama: "Batik Dayak Batang Garing",
    daerah: "Palangkaraya",
    prov: "Kalimantan Tengah",
    teknik: "Tulis",
    warna: ["#B71827", "#4D875E", "#D8C732"],
    img: "https://down-id.img.susercontent.com/file/id-11134207-7r98x-lse40c8megivde",
    makna: "Pohon kehidupan - Batang Garing, poros dunia Dayak",
    filosofi:
      "Pohon kosmik yang hubungkan atas-bawah-dunia tengah. Burung enggang di puncak = penjaga.",
    history:
      "Motif ukir rumah betang diadaptasi ke kain sejak 2000-an. Upaya Dayak klaim ruang tekstil.",
    usage: "Acara adat Dayak, festival budaya.",
    en: "Tree of life, Dayak cosmos. Hornbill on top = guardian. From longhouse carvings to cloth.",
  },
  {
    id: "sentani",
    nama: "Sentani Papua",
    ...
    prov: "Papua",
    teknik: "Cap",
    warna: ["#dc2626", "#facc15", "#2b1d12"],
    img: "https://asset.kgnewsroom.com/photo/pre/2025/07/05/f5cb1fb8-4cf7-4bac-b86f-2f70afc3d64d_jpeg.jpg",
    makna: "Tifa & ombak Danau Sentani - ritme & alam",
    filosofi:
      "Geometri tifa, perahu, danau. Papua ikut menulis batik - bukan hanya Jawa. Indonesia timur punya kain juga.",
    history:
      "Gerakan 2010-an, pengrajin Papua belajar canting di Jawa lalu pulang bawa teknik.",
    usage: "Festival Port Numbay, seragam lokal.",
    en: "Tifa drum, Sentani waves. East Indonesia writes batik too - not just Java.",
  },
  {
    id: "betawi",
    nama: "Betawi Tumpal Pucuk Rebung",
    daerah: "Jakarta",
    prov: "DKI Jakarta",
    teknik: "Cap",
    warna: ["#dc2626", "#22c55e", "#facc15"],
    img: "https://upload.wikimedia.org/wikipedia/commons/3/32/Stamp_of_Indonesia_-_2012_-_Colnect_668276_-_Batik_Jakarta.jpeg",
    makna: "Pucuk rebung - pertumbuhan & harapan baru",
    filosofi:
      "Tumpal segitiga di tepi = doa tumbuh ke atas. Betawi campur Melayu, Arab, Cina - warna ngejreng itu identitas.",
    history:
      "Batik Betawi hampir punah 1970-an, bangkit lagi lewat Sudin Kebudayaan DKI 2000-an.",
    usage: "Abang None, seragam DKI, ondel-ondel backdrop.",
    en: "Bamboo shoot triangle = growth. Betawi loud colors = mixed Malay-Arab-Chinese identity.",
  },
  {
    id: "madura",
    nama: "Madura Sasegan",
    ...
    prov: "Jawa Timur",
    teknik: "Tulis",
    warna: ["#dc2626", "#1a365d", "#22c55e"],
    img: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Batik_Madura.jpg",
    makna: "Berani & tegas - merah darah, biru laut",
    filosofi:
      "Madura tak malu warna tabrak. Sasegan = sisik naga? Banyak tafsir. Yang jelas: petarung.",
    history:
      "Madura batik sejak abad 17, dibawa ulama. Khas: warna 'ngejreng' dan mori kasar.",
    usage: "Karapan sapi, acara Madura, daily wear berani.",
    en: "Daring, clashing red-blue-green. Warrior palette. Rough mori, bold soul.",
  },
  {
    id: "garutan",
    nama: "Garutan",
    ...
    prov: "Jawa Barat",
    teknik: "Tulis",
    warna: ["#9a8c82", "#7c2d12", "#fdf6e3"],
    img: "https://upload.wikimedia.org/wikipedia/commons/3/3b/Batik_Garutan.jpg",
    makna: "Flora Priangan - kalem Sunda",
    filosofi:
      "Bunga kecil-kecil, merica, lereng. Sunda = halus, tidak teriak. Putih dominan = kesederhanaan.",
    history:
      "Garut batik abad 19, pusat priyangan. Sering dilupakan karena kalah tenar Cirebon.",
    usage: "Kebaya Sunda, acara halus.",
    en: "Sundanese calm - tiny florals, white base. Soft, not loud. Priangan subtlety.",
  },
  {
    id: "sasirangan",
    nama: "Sasirangan",
    ...
    teknik: "Kombinasi",
    warna: ["#facc15", "#1a365d", "#dc2626"],
    img: "https://upload.wikimedia.org/wikipedia/commons/a/a7/Kain_Sasirangan.jpg",
    makna: "Menyirang - menjelujur kain, diikat lalu dicelup",
    filosofi:
      "Teknik ikat-jelujur khas Banjar, abad 12 era Lambung Mangkurat. Bukan canting, tapi tusuk.",
    history:
      "Asal dari kain sakral kerajaan Banjar, untuk pengobatan. Sekarang seragam Kalsel tiap Kamis.",
    usage: "Kampus, kantor Kalsel, fashion modern.",
    en: "Jelujur-ikat-dye, 12th century Banjar kingdom. Sacred healing cloth, now daily uniform.",
  },
  {
    id: "tujuh-rupa",
    nama: "Tujuh Rupa",
    ...
    prov: "Jawa Tengah",
    teknik: "Tulis",
    warna: ["#ec4899", "#22c55e", "#38bdf8", "#facc15"],
    img: "https://upload.wikimedia.org/wikipedia/commons/6/63/Batik_Buketan_Pekalongan_Tulis_2.jpg",
    makna: "Tujuh rupa alam - multikulturalisme",
    filosofi:
      "Satu kain ada Cina (burung hong), Jawa (parang), Belanda (bouquet). Pekalongan memang pelabuhan campur.",
    history:
      "Julukan Pekalongan, 1930-an. Motif encim (perempuan Tionghoa) jadi ikon.",
    usage: "Ekspor favorit turis - warna paling 'Indonesia campur'.",
    en: "Seven visages - Chinese, Javanese, Dutch in one cloth. Port city hybrid.",
  },
  {
    id: "sekar-jagad",
    nama: "Sekar Jagad",
    ...
    prov: "DI Yogyakarta",
    teknik: "Tulis",
    warna: ["#7c2d12", "#fdf6e3", "#c9a86a"],
    img: "https://upload.wikimedia.org/wikipedia/commons/6/67/Kain_batik_motif_sekar_jagad.jpg",
    makna: "Peta dunia - sekar = peta, jagad = dunia",
    filosofi:
      "Pulau-pulau motif berbeda jadi satu kain = keberagaman Indonesia. Doa: siapa pakai, dunia terbuka.",
    history:
      "Motif tambal (patchwork) era 18, tiap tambalan motif berbeda - world map patchwork.",
    usage: "Hadiah diplomatik, koleksi. Paling sering jadi cover buku batik.",
    en: "World map patchwork - different islands, one cloth. Who wears it, world opens.",
  },
];
...
function render() {
  ...
  let list = BATIK.filter((b) => {
    ...
    if (term) {
      const hay =
        `${b.nama} ${b.daerah} ${b.prov} ${b.makna} ${b.filosofi} ${b.en}`.toLowerCase();
...
function openModal(id) {
  const b = BATIK.find((x) => x.id === id);
  if (!b) return;
  cur = b;
  $("#mName").textContent = b.nama;
  $("#mProv").textContent = `${b.daerah}, ${b.prov}`;
  const pill = $("#mTeknik");
  pill.textContent = b.teknik;
  pill.className = `pill ${b.teknik === "Tulis" ? "tulis" : b.teknik === "Cap" ? "cap" : "komb"}`;
  $("#mMeaning").textContent = `\u201c${lang === "en" ? b.en : b.makna}\u201d`;
  $("#mFilosofi").textContent = b.filosofi;
  $("#mHistory").textContent = b.history;
  $("#mColors").innerHTML =
    `${b.warna.map((c) => `<span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:${c};border:1px solid rgba(0,0,0,.15);vertical-align:middle;margin-right:4px"></span>${c}`).join(" • ")}`;
  ...
  $("#mMedia").innerHTML =
    `<img src="${img}" alt="${b.nama}" style="max-width:100%;max-height:100%;width:auto;height:auto;object-fit:contain;display:block" crossorigin="anonymous" onerror="this.style.display='none'">`;
...
function shareCurrent() {
  ...
  if (navigator.share) {
    navigator.share({ title: cur.nama, text }).catch(() => {});
...
[q, fProv, fTeknik, fSort].forEach((el) =>
  el.addEventListener("input", render),
);
heroSearch.addEventListener("input", () => {
  q.value = heroSearch.value;
  render();
});
