const BATIK = [
  ...
  {id:"sentani",nama:"Sentani Papua",daerah:"Jayapura",prov:"Papua",teknik:"Cap",warna:["#dc2626","#facc15","#2b1d12"],img:"https://asset.kgnewsroom.com/photo/pre/2025/07/05/f5cb1fb8-4cf7-4bac-b86f-2f70afc3d64d_jpeg.jpg",makna:"Tifa & ombak Danau Sentani - ritme & alam",filosofi:"Geometri tifa, perahu, danau. Papua ikut menulis batik - bukan hanya Jawa. Indonesia timur punya kain juga.",history:"Gerakan 2010-an, pengrajin Papua belajar canting di Jawa lalu pulang bawa teknik.",usage:"Festival Port Numbay, seragam lokal.",en:"Tifa drum, Sentani waves. East Indonesia writes batik too - not just Java."},
  {id:"betawi",nama:"Betawi Tumpal Pucuk Rebung",daerah:"Jakarta",prov:"DKI Jakarta",teknik:"Cap",warna:["#dc2626","#22c55e","#facc15"],img:"https://upload.wikimedia.org/wikipedia/commons/3/32/Stamp_of_Indonesia_-_2012_-_Colnect_668276_-_Batik_Jakarta.jpeg",makna:"Pucuk rebung - pertumbuhan & harapan baru",filosofi:"Tumpal segitiga di tepi = doa tumbuh ke atas. Betawi campur Melayu, Arab, Cina - warna ngejreng itu identitas.",history:"Batik Betawi hampir punah 1970-an, bangkit lagi lewat Sudin Kebudayaan DKI 2000-an.",usage:"Abang None, seragam DKI, ondel-ondel backdrop.",en:"Bamboo shoot triangle = growth. Betawi loud colors = mixed Malay-Arab-Chinese identity."},
  {id:"madura",nama:"Madura Sasegan",daerah:"Pamekasan",prov:"Jawa Timur",teknik:"Tulis",warna:["#dc2626","#1a365d","#22c55e"],img:"https://upload.wikimedia.org/wikipedia/commons/f/fa/Batik_Madura.jpg",makna:"Berani & tegas - merah darah, biru laut",filosofi:"Madura tak malu warna tabrak. Sasegan = sisik naga? Banyak tafsir. Yang jelas: petarung.",history:"Madura batik sejak abad 17, dibawa ulama. Khas: warna 'ngejreng' dan mori kasar.",usage:"Karapan sapi, acara Madura, daily wear berani.",en:"Daring, clashing red-blue-green. Warrior palette. Rough mori, bold soul."},
  {id:"garutan",nama:"Garutan",daerah:"Garut",prov:"Jawa Barat",teknik:"Tulis",warna:["#a3a3a3","#7c2d12","#fdf6e3"],img:"https://upload.wikimedia.org/wikipedia/commons/3/3b/Batik_Garutan.jpg",makna:"Flora Priangan - kalem Sunda",filosofi:"Bunga kecil-kecil, merica, lereng. Sunda = halus, tidak teriak. Putih dominan = kesederhanaan.",history:"Garut batik abad 19, pusat priyangan. Sering dilupakan karena kalah tenar Cirebon.",usage:"Kebaya Sunda, acara halus.",en:"Sundanese calm - tiny florals, white base. Soft, not loud. Priangan subtlety."},
  {id:"sasirangan",nama:"Sasirangan",daerah:"Banjarmasin",prov:"Kalimantan Selatan",teknik:"Kombinasi",warna:["#facc15","#1a365d","#dc2626"],img:"https://upload.wikimedia.org/wikipedia/commons/a/a7/Kain_Sasirangan.jpg",makna:"Menyirang - menjelujur kain, diikat lalu dicelup",filosofi:"Teknik ikat-jelujur khas Banjar, abad 12 era Lambung Mangkurat. Bukan canting, tapi tusuk.",history:"Asal dari kain sakral kerajaan Banjar, untuk pengobatan. Sekarang seragam Kalsel tiap Kamis.",usage:"Kampus, kantor Kalsel, fashion modern.",en:"Jelujur-ikat-dye, 12th century Banjar kingdom. Sacred healing cloth, now daily uniform."},
  {id:"tujuh-rupa",nama:"Tujuh Rupa",daerah:"Pekalongan",prov:"Jawa Tengah",teknik:"Tulis",warna:["#ec4899","#22c55e","#38bdf8","#facc15"],img:"https://upload.wikimedia.org/wikipedia/commons/6/63/Batik_Buketan_Pekalongan_Tulis_2.jpg",makna:"Tujuh rupa alam - multikulturalisme",filosofi:"Satu kain ada Cina (burung hong), Jawa (parang), Belanda (bouquet). Pekalongan memang pelabuhan campur.",history:"Julukan Pekalongan, 1930-an. Motif encim (perempuan Tionghoa) jadi ikon.",usage:"Ekspor favorit turis - warna paling 'Indonesia campur'.",en:"Seven visages - Chinese, Javanese, Dutch in one cloth. Port city hybrid."},
  {id:"sekar-jagad",nama:"Sekar Jagad",daerah:"Yogyakarta",prov:"DI Yogyakarta",teknik:"Tulis",warna:["#7c2d12","#fdf6e3","#c9a86a"],img:"https://upload.wikimedia.org/wikipedia/commons/6/67/Kain_batik_motif_sekar_jagad.jpg",makna:"Peta dunia - sekar = peta, jagad = dunia",filosofi:"Pulau-pulau motif berbeda jadi satu kain = keberagaman Indonesia. Doa: siapa pakai, dunia terbuka.",history:"Motif tambal (patchwork) era 18, tiap tambalan motif berbeda - world map patchwork.",usage:"Hadiah diplomatik, koleksi. Paling sering jadi cover buku batik.",en:"World map patchwork - different islands, one cloth. Who wears it, world opens."}
];
